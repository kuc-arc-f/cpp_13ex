...
import { getJevResult } from "./src/LibJev.js"
...
function App() {
  ...
  const handleSubmit = useCallback(async (value) => {
    ...
    const vector_search = lib.func('char* vector_search(const char* input)');
    const llm_search = lib.func('char* llm_search(const char* query, const char* input)');
    let target = trimmed;
    let responseText = "";
    const resp =vector_search(target)
